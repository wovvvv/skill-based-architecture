...
- **Plan decision handoff and closure — where conclusions go** → Decision capture/handoff: [`plan-feature.md`](templates/skill/workflows/plan-feature.md#user-confirmed-decision-mainline); standalone leaf and confirmed-gap upgrade: [`business-global-model.md`](references/business-global-model.md#confirmed-implementation-gap-intake); desired truth vs implementation fact: [`business-global-model.md`](references/business-global-model.md#desired-truth-and-implementation-fact); distillation: [`business-truth.md`](templates/skill/workflows/rule-update/business-truth.md#plan-decision-source); implementation drift: [`task-execution.md`](templates/skill/workflows/task-execution.md#user-decision-drift-gate); lifecycle/freeze: [`docs/plans/README.md`](docs/plans/README.md#lifecycle). Consumers keep only their immediate action and acceptance hook instead of redefining those owners
