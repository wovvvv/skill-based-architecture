...
- **Defining SBA product direction or whether to absorb a major capability** → use [`define-requirement.md`](templates/skill/workflows/define-requirement.md) and read [`docs/sba-bible.md`](docs/sba-bible.md) as the constitutional product source; only after the Requirement is ready does [`plan-feature.md`](templates/skill/workflows/plan-feature.md) derive implementation means
...
- **Capturing stable macro business meaning without a heavy product-doc taxonomy, delivering standalone modeling directly to a leaf, or upgrading a confirmed implementation gap into one draft Plan** → [`references/business-global-model.md`](references/business-global-model.md)
...
- **Requirement decision handoff and closure — where conclusions go** → Decision capture: [`define-requirement.md`](templates/skill/workflows/define-requirement.md#decision-authority-and-source-fidelity); runtime authority/readiness: [`change-contract.md`](templates/skill/protocol-blocks/change-contract.md#requirement-contract); standalone leaf and confirmed-gap upgrade: [`business-global-model.md`](references/business-global-model.md#confirmed-implementation-gap-intake); desired truth vs implementation fact: [`business-global-model.md`](references/business-global-model.md#desired-truth-and-implementation-fact); distillation: [`business-truth.md`](templates/skill/workflows/rule-update/business-truth.md#requirement-decision-source); implementation drift: [`task-execution.md`](templates/skill/workflows/task-execution.md#user-decision-drift-gate); lifecycle/freeze: [`docs/plans/README.md`](docs/plans/README.md#lifecycle). Plans and other consumers keep only provenance, immediate action, and acceptance-to-proof hooks instead of redefining those owners
...
| [business-global-model.md](references/business-global-model.md) | Optional project-specific macro business layer: admission, user-confirmed desired truth vs current implementation fact, Plan/Fix Bug consumption, drift stop gate, progressive split, and route activation |
