...
- **Plan decision handoff and closure — where conclusions go** → [`templates/skill/workflows/plan-feature.md`](templates/skill/workflows/plan-feature.md) § User-Confirmed Decision Mainline / Complex Steps + [`docs/plans/README.md`](docs/plans/README.md) lifecycle. At implementation handoff, stable user-confirmed business meaning enters routed `references/business/<domain>.md`; future constraints enter `rules/`, rejected alternatives enter gotchas/Pitfalls, and the Plan keeps the question/answer provenance. Later Plan/code/review work replays the active mainline; final `done` reconciles implementation evidence and freezes the Plan. A separate `references/decisions/` directory was tried and removed — it became a silo no routing pulled from
